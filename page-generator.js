                    //<![CDATA[
                       (function () {
                        ...
                        function isVisible(el) {
                          return (
                            parseInt(el.offsetWidth) > 0 &&
                            parseInt(el.offsetHeight) > 0
                          );
                        }

                        function updateSections() {
                          [].forEach.call(
                            document.querySelectorAll("wlg_section"),
                            function (el) {
                        ...
                        var state_selector = document.querySelector(
                          "#wlg_form [name='state']"
                        );
                        var STATES = {
                          af: {
                        ...
                        var country = document.querySelector(
                          "#wlg_form [name='country']"
                        );
                        var lang_section = document.querySelector(
                          "wlg_section[name='lang_selector']"
                        );
                        ...
                        function fillCountries() {
                          var content = "";
                          var sKeys = Object.keys(ALL_COUNTRIES).sort(function (
                            x,
                            y
                          ) {
                            return ALL_COUNTRIES[x].localeCompare(
                              ALL_COUNTRIES[y]
                            );
                          });
                          for (var k in sKeys) {
                        ...
                        function updateCountry(e) {
                          ...
                          var lKeys = Object.keys(l).sort(function (x, y) {
                            return LANG_NAMES[l[x]].localeCompare(
                              LANG_NAMES[l[y]]
                            );
                          });
                          ...
                          for (var idx in lKeys) {
                            ...
                            // TODO: with template
                            content +=
                              '<div class="wlg-form-control-checkbox-group">\
    <label><input type="checkbox" name="lang[]" value="' +
                              lang +
                              '"\
    require_visible="require_visible" ' +
                        ...
                        var w = {
                          ...
                          _validate: function () {
                            ...
                            [].forEach.call(
                              ...
                              function (el) {
                                var failedNames = [];
                                [].forEach.call(
                                  el.querySelectorAll("[require_visible]"),
                                  function (eInner) {
                                    var thisPassed = true;
                                    if (!isVisible(eInner)) {
                                      return;
                                    ...
                                    if (
                                      ...
                                      if (
                                        v === false ||
                                        (typeof v == "object" && v.length < 1)
                                      ) {
                                        thisPassed = false;
                                      }
                                    } else if (
                                      eInner.matches("input[type='email']")
                                    ) {
                                      var v = eInner.value;
                                      if (typeof v == "undefined") {
                                        thisPassed = false;
                                    ...
                                    if (!thisPassed) {
                                      passed = false;
                                      if (
                                        failedNames.indexOf(eInner.name) < 0
                                      ) {
                          ...
                          init: function () {
                            ...
                            [].forEach.call(
                              document.querySelectorAll("." + this.body_class),
                              function (el) {
                            ...
                            [].forEach.call(
                              document.querySelectorAll("." + this.title_class),
                              function (el) {
                                removeClass(el, t.active_class);
                              }
                            );
                        ...
                        function preventEnter(e) {
                          ...
                          if (
                            e.keyCode === 13 &&
                            0 > allowEnter.indexOf(e.target.nodeName)
                          ) {
                            e.preventDefault();
                            e.stopPropagation();
                          }
